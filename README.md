...
Fresh no-mod Skyrim Special Edition / Steam achievement cleanup.
...
- [Current State](docs/00_current_state.md)
...
- [Cheat Policy](docs/02_cheat_policy.md)

## Active phase docs

- [Phase 4 — Thieves Guild](docs/phases/04_thieves_guild.md)
- [Phase 6 — Oblivion Walker](docs/phases/06_oblivion_walker.md)

## Active trackers

- [Thieves Guild City Jobs](docs/trackers/thieves_guild_city_jobs.md)
- [Daedric Artifacts](docs/trackers/daedric_artifacts.md)
...
The old one-file README was archived by commit history reference here:

- [README before split pointer](docs/archive/README_before_split_2026-05-24.md)
